...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/brainrender-napari-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/brainrender-napari-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add brainrender-napari
# for installing globally
pixi global install brainrender-napari
```
...
It is possible to list all of the versions of `brainrender-napari` available on your platform:
...
```
pixi search brainrender-napari --channel conda-forge
```
